        ...
        <div className="syncthing-page">
          ...
          <div className="syncthing-banner">
            ...
            <div className="syncthing-banner__actions">
              {isLoading ? (
                <BtnSimple css="btn-simple--4" disabled>
                  ...
                </BtnSimple>
              ) : isRunning ? (
                ...
                {!isRunning ? (
                  <div className="syncthing-empty">
                    ...
                    <div className="syncthing-empty__text">
                      Start Syncthing to discover peers
                    </div>
                  </div>
                ) : peers.length === 0 ? (
                  ...
                  <div className="syncthing-peer-list">
                    {peers.map((peer, i) => (
                      <div key={i} className="syncthing-peer-item">
                        <div className="syncthing-peer-item__icon">
                          &#x1F5B5;
                        </div>
              ...
              <div className="syncthing-card__body">
                {!isRunning ? (
                  <div className="syncthing-empty">
                    <div className="syncthing-empty__icon">&#x1F517;</div>
                    <div className="syncthing-empty__text">
                      Start Syncthing to pair devices
                    </div>
                  </div>
                ) : codeMode === 'idle' ? (
            ...
            <div className="syncthing-card__header">
              ...
              {isRunning && (
                ...
                >
                  ...
                  {pairedDevices.length - connectedCount} offline
                </span>
              )}
            </div>
            <div className="syncthing-card__body">
              {!isRunning ? (
                <div className="syncthing-empty">
                  <div className="syncthing-empty__icon">&#x1F310;</div>
                  <div className="syncthing-empty__text">
                    Start Syncthing to see connected devices
                  </div>
                </div>
                ...
                <div className="syncthing-empty">
                  <div className="syncthing-empty__icon">&#x1F5C4;</div>
                  <div className="syncthing-empty__text">
                    No devices paired yet. Use Local Network or Remote Pairing
                    above.
                  </div>
                </div>
              ) : (
                  ...
                  {pairedDevices.map((dev, i) => (
                    <div key={i} className="syncthing-device-row">
                      ...
                      <div className="syncthing-device-row__info">
                        <span className="syncthing-device-row__name">
                          {dev.name}
                        </span>
                        <div className="syncthing-device-row__meta">
                          <span>
                            {truncateDeviceId(dev.deviceId)}
                          </span>
                          <span>
                            &#8593; {formatBytes(dev.outBytesTotal)}
                          </span>
                          <span>
                            &#8595; {formatBytes(dev.inBytesTotal)}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="syncthing-device-row__actions">
                        <BtnSimple
                          css="btn-simple--3"
                          onClick={() => unpairDevice(dev.deviceId)}
                        >
                          Unpair
                        </BtnSimple>
                      </div>
            ...
            <div className="syncthing-card">
              ...
              <div className="syncthing-card__body">
                <div className="syncthing-stats">
                  ...
                  <div className="syncthing-stat">
                    <div className="syncthing-stat__value">
